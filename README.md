...
To ensure security, API keys are not included in this repository. You will need to provide your own Google Gemini API key to run the application locally.
